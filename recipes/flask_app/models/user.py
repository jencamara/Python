...
class User:
    schema = "users_and_recipes_schema"
    ...
    def signup_validate(post_data):
        ...
        if not EMAIL_REGEX.match(post_data['email']):
            ...
            is_valid = False
        elif User.pull_from_email({"email": post_data['email']}):
    ...
    def signin_validate(post_data):
        user = User.pull_from_email({"email": post_data['email']})
